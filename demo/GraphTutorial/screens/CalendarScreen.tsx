...
export default class CalendarScreen extends React.Component {
  ...
  async componentDidMount() {
    try {
      ...
      //const events = await GraphManager.getSharedEvents();
      const events = await GraphManager.getMeetingTimeSuggestions();
      await GraphManager.getSchedule();
      await GraphManager.scheduleMeeting();
      this.setState({
        loadingEvents: false,
        events: events.value
      });
